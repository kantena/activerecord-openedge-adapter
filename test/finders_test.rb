...
class FindersTest < Test::Unit::TestCase
  ...
  def test_on_size_find_with_offset
  ...
  #TODO If a Find(:conditions =>"") is generated by another gem or plugin (ie FactoryGirl)
  # columns must be quoted .... else problems if progress reserved words for columns
  # eg : level, status
